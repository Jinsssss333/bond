...
export default function ArbiterEscrows() {
          ...
          >
            ...
            {!escrows || escrows.length === 0 ? (
              <div className="border-2 rounded-lg p-12 text-center">
                <Scale className="h-12 w-12 mx-auto mb-4 opacity-50 text-muted-foreground" />
                <p className="text-muted-foreground">No escrows available.</p>
              </div>
            ) : (
